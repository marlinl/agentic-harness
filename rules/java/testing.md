...
For Spring Boot integration tests, see skill: `spring-boot-patterns`.
...
See skill: `spring-boot-patterns` for Spring Boot testing patterns with MockMvc and Testcontainers.
See skill: `test-quality` for testing expectations.
