...
See skill: `spring-boot-patterns` for Spring Security authentication and authorization patterns.
See rule: `common/security.md` for general security checklists.
