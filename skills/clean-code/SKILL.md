---
name: clean-code
description: Clean Code principles (DRY, KISS, YAGNI), naming conventions, and function design. Use WHENEVER writing new code, modifying existing features, creating classes/methods, or when specifically asked to refactor/review code. Always apply these principles by default to keep code maintainable.
---
...
## When to Use
- **Always active during code generation:** Apply these principles proactively whenever writing new features, classes, or methods.
- **When modifying existing code:** Apply the "Boy Scout Rule" (leave the code cleaner than you found it) while fixing bugs or adding features.
- **When naming things:** Whenever defining new variables, methods, or database models.
- **When specifically requested:** User explicitly says "clean this code", "refactor", or asks for a code review.
- **When encountering code smells:** If you notice long methods, deeply nested conditionals, or magic numbers during your workflow, proactively suggest simplifying them.
